            ...
            <div class="card-body">
                ...
                <div class="container">
                    <table style="table-layout: fixed;">
                        ...
                        @foreach (json_decode($order_item->configuration) as $key => $item)
                        @php
                    ...
                    <table style="table-layout: fixed;">
                        ...
                        <tr>
                            <td>
                                <p style="margin-bottom: 4px;">Gross Amount</p>
                            </td>
                            <td>Rs. {{number_format($order->gross_amount,2)}}</td>
                        </tr>
                        {{-- <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Rs. {{number_format($order->otc_amount,2)}}</td>
                        </tr>
                        @endif
                        <tr>
                            <td>
                            ...
                            <td>Rs. {{number_format($order->convenience_amount,2)}}</td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>Rs. {{number_format($order->gst_amount,2)}}</td>
                        </tr>
                        <tr>
                            <td>Total Amount</td>
